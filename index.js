...
// Block inserts
document.getElementById('btnH1').addEventListener('click', () => insertBlock('h1'));
document.getElementById('btnH2').addEventListener('click', () => insertBlock('h2'));
document.getElementById('btnQuote').addEventListener('click', () => insertBlock('blockquote'));
...
document.getElementById('selSize').addEventListener('change', function() {
  // fontSize 1-7 maps roughly, so use inline style instead
  wrapSelectionWithStyle('font-size', this.value + 'px');
});
